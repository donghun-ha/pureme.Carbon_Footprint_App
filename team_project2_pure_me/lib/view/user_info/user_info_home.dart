...
class UserInfoHome extends StatelessWidget {
  ...
  final userHandler = Get.put(FeedHandler());
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          userHandler.userFeedList.isNotEmpty
                              ? GridView.builder(
                                  shrinkWrap: true,
                                  ...
                                  gridDelegate:
                                      const SliverGridDelegateWithFixedCrossAxisCount(
                                          ...
                                          crossAxisSpacing: 10,
                                          mainAxisSpacing: 10),
                                  itemCount: userHandler.userFeedList.length,
                                  itemBuilder: (context, index) {
                                    Feed feed = userHandler.userFeedList[index];
                                    return GestureDetector(
                                      onTap: () {
                                        userHandler.detailFeed(feed.feedName!);
                                        Get.to(
                                          () => FeedDetail(),
                                          arguments: feed,
                                        )!
