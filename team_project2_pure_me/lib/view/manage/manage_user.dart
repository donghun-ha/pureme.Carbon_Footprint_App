        ...
        Center(
          child: GetBuilder<ManageHandler>(
            builder: (context) {
              return Obx(
                () {
                  return vmhandler.searchUserList.isEmpty? const Text("검색어를 입력해 주십시오"): const Text("메롱");
                }
              );
            }
          ),
                                  ...
                                  if (snapshot.connectionState ==
                                    ...
                                    return Obx(() => Column(
                                          children: [
                                                ...
                                                itemBuilder: (context, index) {
                                                  ...
                                                  return Container(
                                                    decoration: BoxDecoration(
                                                      border: Border.all(
                                                        color: vmhandler.searchUserIndex == index ? Colors.blue : Colors.transparent, 
                                                        width: 2.0,
                                                      ),
                                            ...
                                            Visibility(
                                              visible: vmhandler.searchUserIndex != null,
                                              child: Column(
                                                children: [
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      ...
                                                      Radio(
                                                        value: 1, 
                                                        groupValue: vmhandler.searchUserRadio, 
                                                        onChanged: (value){
                                                          vmhandler.searchUserRadioChanged(value);}
                                                      ),
                                                      const Text('하루'),
                                                      Radio(
                                                        value: 7, 
